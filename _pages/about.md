...
<div style="text-align:center">This is a microscopic view of a complex network with symmetric edge weights, $w_{ji}$, for any pair of nodes $i$ and $j$. The node labeled $i$ in the image has $k_i = 4$ neighbors.</div>
